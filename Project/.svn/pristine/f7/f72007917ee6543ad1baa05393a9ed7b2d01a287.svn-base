...
void drawMenu(uint8_t *mem_video) {
    //memset(mem_video, 001, get_bytes()*get_hres()*get_vres());
    vg_draw_rectangle(0, 0,1024, 768, 1);
    drawXpm(NAME, 300, 0);
    drawXpm(START,300,150);
    drawXpm(INST,300,300);
    drawXpm(EXIT,300,450); 
}

void drawCannon_right(int x){
    drawXpm(cannon, x,704); 
}

void drawCannon_left(int x){
    mirror_xpm(cannon, x,704);
}
