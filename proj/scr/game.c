...
bool checkCollision(){
    if(shot){
        if(ball->x+15 >= cannon2->x && ball->x+15 <= cannon2->x + cannon2->width){
            if(ball->y+31 >= cannon2->y && ball->y+31 <= cannon2->y + cannon2->height){
                draw = false;
                hp2--;
                return true;
            }
        ...
        if(ball->x+31 >= cannon2->x && ball->x+31 <= cannon2->x + cannon2->width){
            if(ball->y+15 >= cannon2->y && ball->y+15 <= cannon2->y + cannon2->height){
                draw = false;
                hp2--;
                return true;
            }
        ...
        if(ball->x+15 <= cannon->x + cannon->width && ball->x+15 >= cannon->x){
            if(ball->y+31 >= cannon->y && ball->y+31 <= cannon->y + cannon->height){
                draw = false;
                hp1--;
                return true;
            }
        ...
        if(ball->x <= cannon->x + cannon->width && ball->x >= cannon->x){
            if(ball->y+15 >= cannon->y && ball->y+15 <= cannon->y + cannon->height){
                draw = false;
                hp1--;
                return true;
            }
...
bool check_for_engame(){
    ...
    if(hp2 == 0){
        ...
        drawSprite(endgame, endgame->x,endgame->y); 
        drawSprite(winner, winner->x, winner->y); 
        write_string(name1, 384-total1/3,450,size1);
        drawSprite(space, space->x, space->y+200);
        return true;
    }
    return false;
